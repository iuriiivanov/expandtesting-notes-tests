...
| TC-001.1.5 | Registration with a short password | test_auth.py::test_register_short_password | 🟢 Covered |
| TC-001.1.6 | Registration without required fields | test_auth.py::test_register_missing_fields | 🟢 Covered |
...
| TC-001.2.3 | Login with a non-existent email | test_auth.py::test_login_nonexistent_email | 🟢 Covered |
| TC-001.2.4 | Login with empty fields | test_auth.py::test_login_empty_fields | 🟢 Covered |
...
| TC-001.6.2 | Logout with an invalid token | test_auth.py::test_logout_invalid_token | 🟢 Covered |
...
| TC-002.1.5 | Create a note without a description | test_notes_crud.py::test_create_note_empty_description | 🟢 Covered |
...
| TC-002.1.8 | Create a note with title > 100 characters | test_notes_crud.py::test_create_note_long_title | 🟢 Covered |
...
| TC-002.2.3 | Retrieve notes list when no notes exist | test_notes_crud.py::test_get_all_notes_empty | 🟢 Covered |
...
| TC-002.3.3 | Retrieve another user's note | test_notes_crud.py::test_get_note_isolation | 🟢 Covered |
...
| TC-002.4.4 | Update a note with an invalid category | test_notes_crud.py::test_update_note_invalid_category | 🟢 Covered |
| TC-002.4.5 | Update another user's note | test_notes_crud.py::test_update_note_isolation | 🟢 Covered |
...
| TC-002.5.4 | Delete another user's note | test_notes_crud.py::test_delete_note_isolation | 🟢 Covered |
| TC-002.5.5 | Re-delete an already deleted note | test_notes_crud.py::test_delete_note_twice | 🟢 Covered |
...
| TC-003.1.5 | Update status of another user's note | test_notes_status.py::test_update_status_isolation | 🟢 Covered |
...
- 🟢 **Covered**: 54 test cases have matching test functions
