...
| TC-001.3.1 | Retrieve profile of an authenticated user | — | 🟡 Test Missing |
| TC-001.3.2 | Retrieve profile without a token | — | 🟡 Test Missing |
| TC-001.3.3 | Update profile with valid data | — | 🟡 Test Missing |
| TC-001.3.4 | Update profile with an empty name | — | 🟡 Test Missing |
...
| TC-002.2.2 | Retrieve notes list without a token | — | 🟡 Test Missing |
...
| TC-002.3.4 | Retrieve a note without a token | — | 🟡 Test Missing |
...
| TC-002.4.3 | Update a note without a token | — | 🟡 Test Missing |
...
| TC-002.5.3 | Delete a note without a token | — | 🟡 Test Missing |
...
| TC-003.1.4 | Update status without a token | — | 🟡 Test Missing |
...
- 🟢 **Covered**: 28 test cases have matching test functions
- 🟡 **Test Missing**: 28 test cases have no test function yet
- 🔵 **Case Missing**: 0 test functions have no test case in the spec

_Last generated: 2026-05-22 10:48:05 UTC_